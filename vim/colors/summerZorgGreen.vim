...
let g:colors_name="summerZorgGreen"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    " Syntax Elements
    call <SID>X("String", "08298A", "", "")
    call <SID>X("Constant", "5E610B", "", "")
    ...
    call <SID>X("jinjaStatement", "0B610B", "fbf4c7", "bold")
